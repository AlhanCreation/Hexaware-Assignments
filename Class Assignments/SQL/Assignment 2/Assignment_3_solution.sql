...
/* list all employees name and salary whose salary matches with employees of department 1 or 3*/
select ename, sal from emp where sal in ( select sal  from emp where deptno in (20,30)) 

/* list all employees name and salary whose salary matches with any of employees whose name ends with A*/
select ename, sal from emp 
where sal 
in ( select sal from emp where ename like '%[a,i,n]')

/*find all employees who work in department as that of empid 20 and earns more than epmid 30 */
select * from emp where deptno	= ( select sal from emp where empno = 7369 ) and sal > (select sal from emp where empno = 7499) 
